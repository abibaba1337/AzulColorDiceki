const DICE_COLORS = [
    ...
    const diceRollSound = new Audio('assets/the-dice-fell.mp3');
    ...
    const spraySoundFiles = [
      'assets/jet-set-radio-spray-1_4CFwPkb.mp3',
      'assets/jet-set-radio-spray-2_pITyzB4.mp3',
      'assets/jet-set-radio-spray-3_c3UntD1.mp3',
      'assets/jet-set-radio-spray-4_gni8YkP.mp3'
    ];
    ...
    const ultraFinishSound = new Audio('assets/universfield-notification-05-140376.mp3');
